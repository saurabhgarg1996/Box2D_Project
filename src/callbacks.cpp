...
#include <iostream>
using namespace std;
//! The namespace contains all the major variables and function definitions.
namespace cs251
{
  int32 test_index = 0;
  ...
  /*! \fn callbacks_t::convert_screen_to_world
  	  \brief This function maps each pixel on the screen to the physical world dimensions.
  */
  ...
  /*! \fn callbacks_t::resize_cb
   		\brief This is called when a resize operation is performed and it maps the elements on a smaller screen to a bigger and vice versa.
  */
  ...
  /*! \fn callbacks_t::keyboard_cb
  	 	\brief This function gets executed on keyboard callbacks and performs operations like zoom in, zoom out, etc corresponding to the keys pressed.
  */ 
 ...
 /*! \fn callbacks_t::keyboard_special_cb
 	 \brief This function records the special callbacks like the arrow key movements to pan in different directions, etc.
 */   
...
/*! \fn callbacks_t::mouse_cb
	\brief This function records mouse callbacks, which checks for left button press, right button press and mouse up and down.
*/   
 ...
 /*! \fn callbacks_t::mouse_motion_cb
 	 \brief This function records callbacks for mouse being in motion and not being in motion.
*/     
...
//cout<<"abc"<<endl;    
 ...
 /*! \fn callbacks_t::restart_cb
 	 \brief This function re-initializes all the parameters when the user clicks on Restart button in the GUI window.
*/ 
 ...
 /*! \fn callbacks_t::pause_cb
 	 \brief This function brings the simulation to a pause when the user clicks the pause button.
*/ 
  ...
  /// Gets executed when the user exits (by pressing the button, or by pressing the crss icon at the top)
