...
/*! \namespace cs251
    \brief This is the one and only namespace in the code. This has all the variables and classes like dominos_t which have the main elemnet generation code and callback code of this project.
*/    
namespace cs251
{
...
//! This is the main function where a new base_sim_t() object is created. GLUI callbacks are set.
int main(int argc, char** argv)
{
  ...
  //! SetContactListener() sets the b2ContactListener ON on the base_sim_t object test.
  ...
  //!GLUI user interface is created.
  create_glui_ui();

  //! The infinite GLUT event loop is entered.
  glutMainLoop();
